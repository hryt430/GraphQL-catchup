...
func (o *Repository) GetOwnerUser() *User {
	if o == nil {
		return nil
	}
...
func (o *Repository) GetIssues() IssueSlice {
	if o == nil {
		return nil
	}

	return o.R.GetIssues()
}
...
func (o *Repository) GetPullrequests() PullrequestSlice {
	if o == nil {
		return nil
	}

	return o.R.GetPullrequests()
}
...
func (repositoryL) LoadIssues(ctx context.Context, e boil.ContextExecutor, singular bool, maybeRepository interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`issues`),
		qm.WhereIn(`issues.repository in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (repositoryL) LoadPullrequests(ctx context.Context, e boil.ContextExecutor, singular bool, maybeRepository interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		...
		qm.WhereIn(`pullrequests.repository in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
