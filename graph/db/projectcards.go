...
func (o *Projectcard) GetProjectcardPullrequest() *Pullrequest {
	if o == nil {
		return nil
	}

	return o.R.GetProjectcardPullrequest()
}
...
func (o *Projectcard) GetProjectcardIssue() *Issue {
	if o == nil {
		return nil
	}

	return o.R.GetProjectcardIssue()
}
...
func (o *Projectcard) GetProjectcardProject() *Project {
	if o == nil {
		return nil
	}

	return o.R.GetProjectcardProject()
}
...
func (projectcardL) LoadProjectcardPullrequest(ctx context.Context, e boil.ContextExecutor, singular bool, maybeProjectcard interface{}, mods queries.Applicator) error {
	...
	if singular {
		...
		if !queries.IsNil(object.Pullrequest) {
			args[object.Pullrequest] = struct{}{}
		}
	...
	query := NewQuery(
		...
		qm.WhereIn(`pullrequests.id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (projectcardL) LoadProjectcardIssue(ctx context.Context, e boil.ContextExecutor, singular bool, maybeProjectcard interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`issues`),
		qm.WhereIn(`issues.id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *Projectcard) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	...
	if !cached {
		...
		ret := strmangle.SetComplement(projectcardAllColumns, strmangle.SetIntersect(insert, update))
