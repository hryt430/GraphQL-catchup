...
func (o *User) GetAuthorIssues() IssueSlice {
	if o == nil {
		return nil
	}

	return o.R.GetAuthorIssues()
}
...
func (o *User) GetOwnerRepositories() RepositorySlice {
	if o == nil {
		return nil
	}

	return o.R.GetOwnerRepositories()
}
...
func (userL) LoadAuthorIssues(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`issues`),
		qm.WhereIn(`issues.author in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (userL) LoadOwnerProjects(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`projects`),
		qm.WhereIn(`projects.owner in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (userL) LoadOwnerRepositories(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		...
		qm.WhereIn(`repositories.owner in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
