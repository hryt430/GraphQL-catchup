...
func (o *Issue) GetAuthorUser() *User {
	if o == nil {
		return nil
	}

	return o.R.GetAuthorUser()
}
...
func (o *Issue) GetIssueRepository() *Repository {
	if o == nil {
		return nil
	}

	return o.R.GetIssueRepository()
}
...
func (o *Issue) GetProjectcards() ProjectcardSlice {
	if o == nil {
		return nil
	}
...
var issueAfterSelectMu sync.Mutex
var issueAfterSelectHooks []IssueHook

var issueBeforeInsertMu sync.Mutex
var issueBeforeInsertHooks []IssueHook
var issueAfterInsertMu sync.Mutex
var issueAfterInsertHooks []IssueHook

var issueBeforeUpdateMu sync.Mutex
var issueBeforeUpdateHooks []IssueHook
var issueAfterUpdateMu sync.Mutex
var issueAfterUpdateHooks []IssueHook

var issueBeforeDeleteMu sync.Mutex
var issueBeforeDeleteHooks []IssueHook
var issueAfterDeleteMu sync.Mutex
var issueAfterDeleteHooks []IssueHook

var issueBeforeUpsertMu sync.Mutex
var issueBeforeUpsertHooks []IssueHook
var issueAfterUpsertMu sync.Mutex
...
func (issueL) LoadProjectcards(ctx context.Context, e boil.ContextExecutor, singular bool, maybeIssue interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		...
		qm.WhereIn(`projectcards.issue in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *Issue) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	...
	if !cached {
		...
		ret := strmangle.SetComplement(issueAllColumns, strmangle.SetIntersect(insert, update))
