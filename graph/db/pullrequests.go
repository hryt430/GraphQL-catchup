...
func (o *Pullrequest) GetPullrequestRepository() *Repository {
	if o == nil {
		return nil
	}

	return o.R.GetPullrequestRepository()
}
...
func (o *Pullrequest) GetProjectcards() ProjectcardSlice {
	if o == nil {
		return nil
	}

	return o.R.GetProjectcards()
}
...
func (pullrequestL) LoadProjectcards(ctx context.Context, e boil.ContextExecutor, singular bool, maybePullrequest interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		...
		qm.WhereIn(`projectcards.pullrequest in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *Pullrequest) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	...
	if !cached {
		...
		ret := strmangle.SetComplement(pullrequestAllColumns, strmangle.SetIntersect(insert, update))
